...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { age: @dog.age, gender: @dog.gender, image: @dog.image, spayed/neutered: @dog.spayed/neutered, type: @dog.type }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { age: @dog.age, gender: @dog.gender, image: @dog.image, spayed/neutered: @dog.spayed/neutered, type: @dog.type }
    assert_redirected_to dog_path(assigns(:dog))
  end
